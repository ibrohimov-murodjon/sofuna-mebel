...
function MaxsulotQoshish() {
  ...
  const deleteApi = "https://custom.uz/products/company-product/";
  const queryClient = useQueryClient();
  const getAddProductFn = async () => {
    const request = await fetch("https://custom.uz/products/company-product/");
  ...
  const { mutate } = useMutation({
    mutationFn: (id) => deleteElement(id, deleteApi),
    onSuccess: () => {
